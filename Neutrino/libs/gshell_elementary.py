...
def install():
	if path.isdir("/usr/share/themes/gnome-shell/elementary") == True:
		...
		if set == 'ok':
			base.web_install("http://espacoliberdade.blog.br/neutrino/packages/gnome-shell-theme-elementary-1.0-1.fc15.noarch.rpm", "gnome-shell-theme-elementary-1.0-1.fc15.noarch.rpm")
			file = open("/tmp/neutrino/text_var", "w")
